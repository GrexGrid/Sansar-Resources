...
public class Reflective_Stopwatch_Reader : SceneObjectScript
{
    #region ResetTime
    ...
    void elapsed(ScriptEventData elapsed)
    {
    ...
    public override void Init()
    {
        ...
        Log.Write(LogLevel.Info, Script.ID.ToString(), nameof(Reflective_Stopwatch_Reader));
