...
public class Reflective_Stopwatch : SceneObjectScript
{
    #region ResetTime
    ...
    private void resetElapsed(ScriptId id)
    {
        ...
        resetTime.StartTime = DateTime.Now;
    ...
    public override void Init()
    {
        ...
        Log.Write(LogLevel.Info, Script.ID.ToString(), nameof(Reflective_Stopwatch));
